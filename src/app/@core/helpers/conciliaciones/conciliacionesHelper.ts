...
import {
    DATOS_LISTA_CONCILIACIONES,
    CONFIGURACION_LISTA_CONCILIACIONES,
    DATOS_EXTRACTO,
    CONFIGURACION_EXTRACTO,
    DATOS_MOV_CONTABLE,
    CONFIGURACION_MOV_CONTABLE,
    DATOS_ESTADO_PAGO,
    CONFIGURACION_ESTADO_PAGO,
    DATOS_ND_LIBROS,
    DATOS_NC_LIBROS,
    DATOS_ND_EXTRACTO,
    DATOS_NC_EXTRACTO,
    CONFIGURACION_COMPARACION,
    DATOS_CONCILIACION,
    CONFIGURACION_CONCILIACION,
    DATOS_CONTABILIZACION_ND_libros,
    DATOS_CONTABILIZACION_NC_libros,
